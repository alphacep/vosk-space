...
| **German**                                                                                                |       |            |     |  |
| [vosk-model-de-0.21](https://alphacephei.com/vosk/models/vosk-model-de-0.21.zip)                          |  1.9G | 9.30 (Tuda-de test), 24.10 (podcast) 11.99 (cv-test) | Big narrowband German model for telephony and server. **NOTE:** To run this model on a machine with less than 16GB RAM remove the folder 'rnnlm' (faster but less accurate). | Apache 2.0 |
